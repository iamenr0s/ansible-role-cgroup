...
Thanks for taking the time to contribute to `iamenr0s.ansible_role_cgroup`!
...
Molecule uses Podman both locally and in CI. The CI matrix covers Debian, Ubuntu, AlmaLinux, Rocky Linux, and Fedora — changes must not break any supported distro (see "Supported Platforms" in `README.md`).
